        ...
        <div className='container p-5 flex justify-center'>
            <div className='bg-green-200 shadow-2xl m-10 rounded p-10 w-2/5'>
                <div className='mb-4'>
                    ...
                    <input className='p-1 shadow-lg outline-none rounded w-3/5' type="email" id='email' onChange={e => setEmail(e.target.value)} />
                </div>
                <div className='mb-4'>
                    <label className="text-gray-700 text-xl font-bold mr-4" htmlFor="password">Password</label>
                    <input className='p-1 shadow-lg outline-none rounded w-3/5' type="password" id='password' onChange={e => setPassword(e.target.value)} />
                </div>
